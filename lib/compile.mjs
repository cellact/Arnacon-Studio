...
function compileIdentityPack(pack, screens, methods, events) {
  if (pack.pairing) {
    screens.add('PAIRING');
    add(methods, ['scanQrCode', 'startBrowserPairing', 'stopBrowserPairing', 'getBrowserPairing']);
    add(events, ['pairing-status', 'pairing-ready']);
  }
...
export function compile(spec) {
  ...
  if (identityPack) compileIdentityPack(identityPack, screens, methods, events);
